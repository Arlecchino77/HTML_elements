# HTML_elements
### Проект на тему: разработка элементов html вариант 8
### студент группы 25ИС11-Д Жуков Вадим
### Stack: HTML, CSS, VS Code

<img src="https://github.com/Arlecchino77/HTML_elements/blob/main/screen.jpg?raw=true" alt="Screen">
...
<body style="background-color: #DCDCDC;">
    <div class="chat-card">
        <img src="../images/soprano.jpg" alt="Avatar" class="avatar">
            <div class="content">
                <div class="name">Тони сопрано</div>
                <div class="message">
